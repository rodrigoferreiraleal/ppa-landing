...
<title>PPA Portugal | Motores Automação Premium - Preço de Fábrica</title>
<meta name="description" content="Motores PPA com abertura ultra-rápida. Stock em Portugal, preços até 40% mais baixos. Distribua automatismos premium.">
...
<a href="SEU_CATALOGO.pdf" class="btn btn-download" download>📥 Descarregar Catálogo</a>
</div>
</div>
</section>
...
<a href="SU_CATALOGO.pdf" class="btn btn-download" download>📥 Descargar Catálogo</a>
</div>
</div>
</section>
...
<img class="product-img" src="Dz-Cube-850-Jetflex-Brushless-2023_03_1682343883543__1_.png" alt="Motor DZ Cube Jetflex 850kg">
</div>
...
<li>Desbloqueio manual com chave</li>
</ul>
</div>
</div>
...
<div class="product-card">
<div class="product-img-wrapper">
<img class="product-img" src="PPA-Dz-Stark-Jetflex-1123_01_1699274845906.png" alt="Motor DZ Stark Jetflex Industrial">
</div>
<div class="product-content">
...
<div class="product-card">
<div class="product-img-wrapper">
<img class="product-img" src="DZ_IND.png" alt="Motor DZ IND Industrial">
</div>
<div class="product-content">
...
<div class="product-card">
<div class="product-img-wrapper">
<img class="product-img" src="Piston_Cond.png" alt="Motor Pistão Batente">
</div>
<div class="product-content">
...
<div class="product-card">
<div class="product-img-wrapper">
<img class="product-img" src="PIVO_SK-jetflex_1678886502610.png" alt="Motor Pivô SK Jetflex">
</div>
<div class="product-content">
...
<div class="product-card">
<div class="product-img-wrapper">
<img class="product-img" src="Cancela_K10.png" alt="Barreira Automática K10">
</div>
<div class="product-content">
...
<h3>DZ Cube Jetflex</h3>
<p>Motor deslizante brushless de alto rendimiento para puertas hasta 850kg. Apertura ultra-rápida con tecnología de punta.</p>
<ul class="product-features">
<li>Capacidad hasta 850kg</li>
<li>Motor brushless silencioso</li>
<li>Apertura en 8 segundos</li>
<li>Sistema anti-aplastamiento</li>
<li>Desbloqueo manual con llave</li>
</ul>
</div>
</div>
...
<div class="product-content">
<span class="product-badge">ALTA POTENCIA</span>
<h3>DZ Stark Jetflex</h3>
<p>Motor industrial para puertas pesadas hasta 1500kg. Ideal para condominios e industrias con alto flujo.</p>
<ul class="product-features">
<li>Capacidad hasta 1500kg</li>
<li>Motor industrial Jetflex</li>
<li>Uso intensivo diario</li>
...
<span class="product-badge">INDUSTRIAL</span>
<h3>DZ IND</h3>
<p>Motor deslizante industrial con tecnología robusta para uso comercial intensivo.</p>
<ul class="product-features">
<li>Uso industrial intensivo</li>
<li>Alta durabilidad</li>
<li>Cremallera incluida</li>
<li>Sensor de obstáculos</li>
...
<div class="product-card">
<div class="product-img-wrapper">
<img class="product-img" src="Piston_Cond.png" alt="Motor Pistón Batiente">
</div>
<div class="product-content">
<span class="product-badge">BATIENTE</span>
<h3>Motor Pistón</h3>
<p>Automatismo de batiente electromecánico para puertas de 2 hojas. Instalación simple y rápida.</p>
<ul class="product-features">
<li>Puertas de batiente</li>
<li>Apertura hasta 180°</li>
<li>Central electrónica integrada</li>
<li>Ajuste de fuerza</li>
<li>Ideal para condominios</li>
</ul>
</div>
</div>
...
<div class="product-card">
<div class="product-img-wrapper">
<img class="product-img" src="PIVO_SK-jetflex_1678886502610.png" alt="Motor Pivotante SK Jetflex">
</div>
<div class="product-content">
<span class="product-badge">PIVOTANTE</span>
<h3>Pivô SK Jetflex</h3>
<p>Motor para puertas pivotantes hasta 500kg. Tecnología brushless para apertura suave y silenciosa.</p>
<ul class="product-features">
<li>Puertas pivotantes</li>
<li>Hasta 500kg de capacidad</li>
<li>Motor Jetflex silencioso</li>
<li>Bajo consumo</li>
<li>Instalación simplificada</li>
</ul>
</div>
</div>
...
<div class="product-card">
<div class="product-img-wrapper">
<img class="product-img" src="Cancela_K10.png" alt="Barrera Automática K10">
</div>
<div class="product-content">
<span class="product-badge">ULTRA-RÁPIDA</span>
<h3>Barrera K10</h3>
<p>Barrera automática de alta velocidad con iluminación LED. Apertura en 3 segundos para control de accesos.</p>
<ul class="product-features">
<li>Apertura en 3 segundos</li>
...
<p>Grande stock em Portugal para entrega imediata. Sem esperas, sem atrasos. Os seus clientes ficam satisfeitos.</p>
</div>
<div class="benefit">
<div class="benefit-icon">🛠️</div>
<h3>Suporte Técnico Local</h3>
<p>Equipa técnica em Portugal para suporte rápido. Atendemos instaladores via WhatsApp, telefone e email todos os dias.</p>
</div>
<div class="benefit">
<div class="benefit-icon">💰</div>
...
<p>Garantia de fábrica + reposição rápida de peças. Nunca deixamos sem suporte os nossos parceiros instaladores.</p>
</div>
</div>
</section>

<!-- BENEFICIOS ESPAÑOL -->
<section class="benefits" lang="es">
<div class="section-header">
<h2>¿Por Qué Elegir PPA?</h2>
<p>Ventajas exclusivas para instaladores y revendedores profesionales</p>
</div>
<div class="benefits-grid">
<div class="benefit">
<div class="benefit-icon">🏭</div>
<h3>Fabricación a Escala</h3>
<p>Producimos miles de motores mensualmente en Brasil. Esto garantiza precios imposibles de competir y disponibilidad permanente.</p>
</div>
<div class="benefit">
<div class="benefit-icon">⚡</div>
<h3>Velocidad Incomparable</h3>
<p>Nuestros motores abren 3x más rápido que la competencia europea. Tecnología brushless Jetflex de última generación.</p>
</div>
<div class="benefit">
<div class="benefit-icon">📦</div>
<h3>Stock Permanente en PT</h3>
<p>Gran stock en Portugal para entrega inmediata. Sin esperas, sin retrasos. Sus clientes quedan satisfechos.</p>
</div>
<div class="benefit">
<div class="benefit-icon">🛠️</div>
<h3>Soporte Técnico Local</h3>
<p>Equipo técnico en Portugal para soporte rápido. Atendemos instaladores vía WhatsApp, teléfono y email todos los días.</p>
</div>
<div class="benefit">
<div class="benefit-icon">💰</div>
<h3>Mejor Precio Garantizado</h3>
<p>Como fabricantes, eliminamos intermediarios. Compare con Nice, CAME, BFT - nuestro precio es hasta 40% más bajo.</p>
</div>
<div class="benefit">
<div class="benefit-icon">⭐</div>
<h3>Post-Venta Premium</h3>
<p>Garantía de fábrica + reposición rápida de piezas. Nunca dejamos sin soporte a nuestros socios instaladores.</p>
</div>
</div>
</section>
...
<!-- COBERTURA ESPAÑOL -->
<section class="coverage" lang="es">
<h2>Atendemos Instaladores en Portugal & Galicia</h2>
<div class="cities-grid">
<div class="city-card"><h3>Lisboa</h3><p>Portugal</p></div>
<div class="city-card"><h3>Leiria</h3><p>Portugal</p></div>
<div class="city-card"><h3>Mafra</h3><p>Portugal</p></div>
...
<a href="https://wa.me/351SEUNUMERO?text=Olá!%20Sou%20instalador%20e%20gostaria%20de%20conhecer%20as%20condições%20para%20revenda%20de%20motores%20PPA" class="btn btn-whatsapp" style="font-size:1.25rem;padding:20px 45px">💬 Falar no WhatsApp Agora</a>
</div>
</section>

<!-- CTA ESPAÑOL -->
<section class="cta-section" lang="es">
<div class="cta-content">
<h2>¿Listo para Trabajar con PPA?</h2>
<p>Hable con nosotros ahora y descubra cómo podemos impulsar su negocio con motores premium y precios de fabricante. Stock permanente en Portugal y soporte técnico garantizado.</p>
<div class="cta-phone">📞 +351 XXX XXX XXX</div>
<a href="https://wa.me/351SEUNUMERO?text=¡Hola!%20Soy%20instalador%20y%20me%20gustaría%20conocer%20las%20condiciones%20para%20reventa%20de%20motores%20PPA" class="btn btn-whatsapp" style="font-size:1.25rem;padding:20px 45px">💬 Hablar por WhatsApp Ahora</a>
</div>
</section>
